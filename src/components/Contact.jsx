  ...
  return (
    ...
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
        <form ref={form} onSubmit={sendEmail} className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                <p className='text-4xl fond-bold inline border-b-4 text-[#5ce1e6] text-gray-300'>Contact</p>
            ...
            <button className='text-white border-2 hover:text-[#5ce1e6] hover:text-[#5ce1e6] px-4 py-3 my-8 mx-auto flex items-center'>
