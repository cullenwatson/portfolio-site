  ...
  return (
    <div name='skills' className='w-full h-screen bg-[#0a192f] text-gray-300'>
        ...
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
            <div>
                <p className='text-4xl font-bold inline border-b-4 border-teal-700 '>Skills</p>
            ...
            <div className='w-full grid grid-cols-2 sm:grid-cols-3 gap-6 text-center py-8'>
                ...
                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
                    <img className='w-20 mx-auto' src={Java} alt="HTML icon"></img>
                ...
                <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
                    <img className='w-20 mx-auto' src={CPlus} alt="HTML icon"></img>
